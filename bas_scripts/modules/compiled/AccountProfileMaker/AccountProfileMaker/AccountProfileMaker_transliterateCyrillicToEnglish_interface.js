...
<%= _.template($('#input_constructor').html())({id:"pdqdfacu", description:"cyrillicText", default_selector: "string", disable_int:true, value_string: "", help: {description: "The Cyrillic text to transliterate."} }) %>
