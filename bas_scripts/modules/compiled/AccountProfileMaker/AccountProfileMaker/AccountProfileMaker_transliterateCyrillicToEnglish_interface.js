...
<%= _.template($('#input_constructor').html())({id:"wrgwavai", description:"cyrillicText", default_selector: "string", disable_expression:true, disable_int:true, value_string: "", help: {description: "The Cyrillic text to transliterate."} }) %>
