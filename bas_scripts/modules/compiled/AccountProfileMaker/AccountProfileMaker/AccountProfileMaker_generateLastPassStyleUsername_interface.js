...
<div class="tooltipinternal">
    <div class="tr tooltip-paragraph-first-fold">Generates a LastPass-like pronounceable username, ensuring it meets a
        specified minimum length by utilizing weighted transitions between letter pairs for natural phonetic flow.
    </div>
</div>
<%= _.template($('#back')
        .html())({
